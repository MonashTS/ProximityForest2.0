...
//            "-data=C:/Users/cwtan/workspace/Dataset/BakeoffNew30/",
...
//        System.out.print(Application.outputPath);
        ...
        if (Application.fold8020 == 0) {
            trainData = loader.readUCRTrain(problem, Application.datasetPath);
    ...
    private static void saveResults(String outputPath, String problem, String classifier, int nThreads,
                                    PFResults trainResults, PFResults testResults, String filename) throws Exception {

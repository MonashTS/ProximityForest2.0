...
namespace libtempo {
  ...
  public:
    ...
    inline const auto& operator [](std::string l) const { return _bcm.at(l); }
  ...
  private:
    ...
    std::map<size_t, std::string> _index_to_label;
  ...
  public:
    ...
    inline const std::map<size_t, std::string>& index_to_label() const { return _index_to_label; }
    ...
    inline json to_json() const {
      ...
      j["dataset_name"] = name();
      j["dataset_size"] = size();
      j["dataset_label"] = label_to_index();
  ...
  arma::Col<size_t> get_class_cardinalities(const DatasetHeader& header, const ByClassMap& bcm) {
